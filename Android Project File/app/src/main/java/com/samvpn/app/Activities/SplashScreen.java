...
public class SplashScreen extends AppCompatActivity {
        ...
        Thread thread = new Thread(new Runnable() {
            ...
            public void run() {
                try  {
                    ...
                    oneConnect.initialize(SplashScreen.this, "b1Cf1gGlzNC8..71jdS136CJIJsXQu4kV3");  // You need to put Your Own Api Key
                    try {
    ...
    private void checkServers() {
        new Handler().postDelayed(new Runnable() {
            @Override
            public void run() {
                if(Constants.FREE_SERVERS.equals("") && Constants.PREMIUM_SERVERS.equals("")) {
                    checkServers();
                } else {
